...
def main():
    ...
    queue_name = "promocoes_c2_queue"
    declare_queue(channel, queue_name)
    bind_queue(channel, queue_name, PROMOCOES_EXCHANGE, "promocao.categoria.*")
    ...
    print(f" [*] {CONSUMER} aguardando promocoes de todas as categorias...")
